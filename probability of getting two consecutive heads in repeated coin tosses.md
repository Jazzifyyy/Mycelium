...
&= \mathbb{P}(E_{n-2})\mathbb{P}(\epsilon_{1}=1)\mathbb{P}(\epsilon_{2}=1) + \mathbb{P}(E_{n-2})\mathbb{P}(\epsilon_{1}=1)\mathbb{P}(\epsilon_{2}=0) + \mathbb{P}(\epsilon_{1}=0)\mathbb{P}(E_{n-1}) \\
&= p^2\cdot p_{n-2} + p(1-p)p_{n-2} + (1-p)p_{n-1}
\end{align}$$