...
4. Form a linear combination of all the sets with arbitrary coefficients. Determine the coefficients by demanding that it satisfies the differential equation. That is the required particular solution.